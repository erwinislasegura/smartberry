                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td class="text-center">
                                                                <span href="#" class="dropdown-item" data-toggle="tooltip" title="Informe">
                                                                    <button type="button" class="btn  btn-danger  btn-block btn-sm" id="defecto" <?php if ($r['ESTADO'] == "1") { echo "disabled"; } ?> name="informe" title="Informe" Onclick="abrirPestana('../../assest/documento/informeProceso.php?parametro=<?php echo $r['ID_PROCESO']; ?>&&usuario=<?php echo $IDUSUARIOS; ?>'); ">
