...
if ( $TEMPORADAS) {
    $ARRAYEXIINDUSTRIAL1= $EXIINDUSTRIAL_ADO->listarExiindustrialTemporadaDisponibleCBXEst(  $TEMPORADAS, $ESPECIE);
    $ARRAYEXIINDUSTRIAL2 = $EXIINDUSTRIAL_ADO->listarExiindustrialRechazoMPTemporadaDisponibleCBXEst(  $TEMPORADAS, $ESPECIE);
}
?>
