...
if ( $TEMPORADAS) {
    $ARRAYEXIEXPORTACION = $EXIEXPORTACION_ADO->listarExiexportacionAgrupadoPorFolioTemporadaDisponibleEst( $TEMPORADAS, $ESPECIE);
}
                                            ...
                                            <table id="existenciapt_estadisticas" class="table-hover" style="width: 300%;">
                                                ...
                                                <tbody>
                                                    <?php foreach ($ARRAYEXIEXPORTACION as $s) : ?>
                                                        ...
                                                        <?php $ARRAYEXISTENCIA=$EXIEXPORTACION_ADO->listarExiexportacionTemporadaPorFolioDisponible( $TEMPORADAS,$s['FOLIO_AUXILIAR_EXIEXPORTACION'] );  ?>                                                                                                                    
