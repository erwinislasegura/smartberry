...
//EXPECIALIZADOS
    //FRUTA
        ...
        */
        ...
        var tableProceso = $('#procesoEstadisticaProductor').DataTable({
            //MARCO EN ROJO LOS DATOS QUE SEA IGUAL A ZERO PARA ENVASE, NETO BRUTO
            /*
            "createdRow":function(row, data,index){
                //pintar una celda
            ...
            */  
            ...
            'drawCallback':function(){
                var api =this.api();  
                var totalnetoeconsolidado = new Intl.NumberFormat('de-DE').format(parseFloat(api.column(9,{page:'current'}).data().sum()).toFixed(2));            
                var totalnetoexpoconsolidado = new Intl.NumberFormat('de-DE').format(parseFloat(api.column(10,{page:'current'}).data().sum()).toFixed(2));            
                var totalnetoexpodconsolidado2 = new Intl.NumberFormat('de-DE').format(parseFloat(api.column(12,{page:'current'}).data().sum()).toFixed(2));            
                var totalnetoindconsolidado = new Intl.NumberFormat('de-DE').format(parseFloat(api.column(15,{page:'current'}).data().sum()).toFixed(2));           
                console.log("neto entrada: "+  totalnetoeconsolidado);            
                console.log("neto expo: "+  totalnetoexpoconsolidado);           
                console.log("neto expo: "+  totalnetoexpodconsolidado2);           
                console.log("neto expo: "+  totalnetoindconsolidado); 
        ...
        //packing             
        var tableProceso = $('#procesoFruta').DataTable({
            //MARCO EN ROJO LOS DATOS QUE SEA IGUAL A ZERO PARA ENVASE, NETO BRUTO
            /*
            "createdRow":function(row, data,index){
                //pintar una celda
        ...
        //existencia
        var tableExistenciampEstadisticas = $('#existenciamp_estadisticas').DataTable({
            //MARCO EN ROJO LOS DATOS QUE SEA IGUAL A ZERO PARA ENVASE, NETO BRUTO
        ...
        var tableExistenciapt_estadisticas = $('#existenciapt_estadisticas').DataTable({
            //MARCO EN ROJO LOS DATOS QUE SEA IGUAL A ZERO PARA ENVASE, NETO BRUTO
        ...
        var tableExistenciapt = $('#existenciapt').DataTable({
            ...
            'drawCallback':function(){
                ...
                var totalenvaseconsolidado = new Intl.NumberFormat('de-DE').format(parseFloat(api.column(10,{page:'current'}).data().sum()).toFixed(0));
                var totalpallet = new Intl.NumberFormat('de-DE').format(parseFloat(api.column(10,{page:'current'}).data().count()).toFixed(0));
