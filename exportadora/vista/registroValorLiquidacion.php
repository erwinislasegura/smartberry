...
/**/
$ARRAYICARGA = $ICARGA_ADO->listarIcargaDespachadoNoLiquidacionCBX($EMPRESAS, $TEMPORADAS);
...
<head>
    <title> Registro Valor Liquidación</title>
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="#">Registro Valor Liquidación </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                    ...
                    <section class="content">
                        <div class="box">
                            <div class="box-header with-border bg-primary">                                   
                                <h4 class="box-title">Registro de Valor Liquidación</h4>                                        
                            </div>
            ...
            if (isset($_REQUEST['CREAR'])) {
                ...
                echo '<script>
                    Swal.fire({
                        ...
                        location.href = "registroValorLiquidacion.php?op&id='.$id_dato.'&a='.$accion_dato.'";                        
                    })
                </script>';
                 ...
                 if ($accion_dato == "crear") {
                    ...
                    echo '<script>
                        Swal.fire({
                            ...
                            text:"El registro de Valor Liquidación se ha modificada correctamente",
                            showConfirmButton: true,
                            confirmButtonText:"Cerrar",
                            closeOnConfirm:false
                        }).then((result)=>{
                    ...
                    if ($accion_dato == "crear") {
                        ...
                        echo '<script>
                            Swal.fire({
                                ...
                                text:"Este Valor Liquidación se encuentra cerrada y no puede ser modificada.",
                                showConfirmButton: true,
                                confirmButtonText:"Cerrar",
                                closeOnConfirm:false
                            }).then((result)=>{
