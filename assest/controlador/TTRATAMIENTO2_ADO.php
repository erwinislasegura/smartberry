 ...
 //LISTAR TODO CON LIMITE DE 6 FILAS   
    public function listarTtratamiento(){
        try{
            ...
            $datos=$this->conexion->prepare("SELECT * FROM  fruta_tratamineto2  limit 8;	");
            $datos->execute();
    ...
    public function listarTtratamientoCBX(){
        try{
            ...
            $datos=$this->conexion->prepare("SELECT * FROM  fruta_tratamineto2  WHERE  ESTADO_REGISTRO  = 1;	");
            $datos->execute();
            $resultado = $datos->fetchAll();
            $datos=null;
    ...
    public function listarTtratamiento2CBX(){
        try{
            ...
            $datos=$this->conexion->prepare("SELECT * FROM  fruta_tratamineto2  WHERE  ESTADO_REGISTRO  = 0;	");
            $datos->execute();
            $resultado = $datos->fetchAll();
            $datos=null;
    ...
    public function buscarNombreTtratamiento($NOMBRE){
        try{
            ...
            $datos=$this->conexion->prepare("SELECT * FROM  fruta_tratamineto2  WHERE  NOMBRE_TTRATAMIENTO  LIKE '%".$NOMBRE."%';");
            $datos->execute();
            $resultado = $datos->fetchAll();
            $datos=null;
    ...
    public function agregarTtratamiento(TTRATAMIENTO2 $TTRATAMIENTO2){
        try{
    ...
    public function eliminarTtratamiento($id){
        try{$sql="DELETE FROM  fruta_tratamineto2  WHERE  ID_TTRATAMIENTO =".$id.";";
    ...
    public function actualizarTtratamiento(TTRATAMIENTO2 $TTRATAMIENTO2){
        try{
            $query = "
    ...
    public function deshabilitar(TTRATAMIENTO2 $TTRATAMIENTO2){
    ...
    //CAMBIO A ACTIVADO
    public function habilitar(TTRATAMIENTO2 $TTRATAMIENTO2){
        try{
            $query = "
    UPDATE  fruta_tratamineto2  SET	
             MODIFICACION = SYSDATE(),           		
