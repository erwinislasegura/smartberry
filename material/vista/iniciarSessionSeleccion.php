...
<?php
        if (isset($_REQUEST['ENTRAR'])) {
            ...
            $AUSUARIO_ADO->agregarAusuario2('NULL',2,0,"".$_SESSION["NOMBRE_USUARIO"].", Inicio Sesion, Seleccion","usuario_usuario",$_SESSION["ID_USUARIO"],$_SESSION["ID_USUARIO"],$_REQUEST["EMPRESA"],$_REQUEST["PLANTA"],$_REQUEST['TEMPORADA'] );            
